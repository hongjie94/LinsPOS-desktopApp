...
EXapp.options("*", cors({ origin: devMode, optionsSuccessStatus: 200 }));
EXapp.use(cors({ origin: devMode, optionsSuccessStatus: 200 }));

// Initialize the printer
let printer = new ThermalPrinter({
  type: PrinterTypes.TANCA,                                 
  interface: 'tcp://192.168.1.87:9100',        // tcp://192.168.0.201:9100             
...
EXapp.post("/sendRecepit", (req, res) => {   
...
EXapp.post("/openCashDrawer", (req, res) => {   
...
function createWindow () {
  ...
  win.loadFile('lins-pos/build/index.html');
